...
content = content.replace(/\b(LinK\d+)\b/g, (match, p1) => '<a href="http://xmuoj.com/contest/362/problem/' + p1 + '" target="_blank">' + p1 + '</a>');
content = content.replace(/\b(JD\d+)\b/g, (match, p1) => '<a href="http://xmuoj.com/contest/357/problem/' + p1 + '" target="_blank">' + p1 + '</a>');
