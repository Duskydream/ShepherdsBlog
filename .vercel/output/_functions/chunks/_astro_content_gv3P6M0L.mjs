import { aD as objectType, aE as dateType, aF as numberType, aG as arrayType, aH as stringType, w as AstroError, aI as UnknownContentCollectionError, a as createComponent, aJ as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, am as escape, aK as renderUniqueStylesheet, aL as renderScriptElement, aM as createHeadAndContent, r as renderComponent } from './astro/server_BSSrx8qw.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_B-Yimc7v.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://duskydream.icu", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Bt0X4mJE.mjs').then(n => n._);
